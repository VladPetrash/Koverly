...
window.addEventListener("alpine:init", () => {
    ...
    Alpine.data("exchanger", () => ({
        ...
        sellValue() {
            ...
            if(this.data.rateLock == NaN || this.data.totalFrom == NaN || this.data.rate == NaN || this.data.inverseRate == NaN || this.data.valueTo == NaN) {
                this.data.rateLock = '-';
                this.data.totalFrom = '-';
                this.data.rate = '-';
        ...
        buyValue() {
            ...
            if(this.data.rateLock == NaN || this.data.totalFrom == NaN || this.data.rate == NaN || this.data.inverseRate == NaN || this.data.valueFrom == NaN) {
                this.data.rateLock = '-';
                this.data.totalFrom = '-';
                this.data.rate = '-';
                this.data.inverseRate = '-';
