...
window.addEventListener("alpine:init", () => {
    ...
    Alpine.data("exchanger", () => ({
        ...
        sellValue() {
            ...
            this.data.rate = this.data.rate.toLocaleString("en-US", {maximumFractionDigits: 2,});
            this.data.inverseRate = this.data.inverseRate.toLocaleString("en-US", {maximumFractionDigits: 2,});
            console.log("sell");
        },
