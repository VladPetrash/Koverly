...
window.addEventListener("alpine:init", () => {
    ...
    Alpine.data("exchanger", () => ({
        ...
        sellValue() {
            ...
            this.data.valueTo = this.data.valueToNumber;
            this.data.rateLock = this.data.rateLock;
            this.data.totalFrom = this.data.totalFrom;
            this.data.rate = this.data.rate;
            this.data.inverseRate = this.data.inverseRate;
            console.log("sell");
        },
