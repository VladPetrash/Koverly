...
window.addEventListener("alpine:init", () => {
    ...
    Alpine.data("exchanger", () => ({
        ...
        async refreshData(callback) {
            ...
            this.data.inverseRate = (1 * result.rate).toFixed(5);
            if (callback) {
                callback.apply(this);
            }
        },
        ...
        sellValue() {
            ...
            console.log(this.data.rateLock, this.data.totalFrom, this.data.rate, this.data.inverseRate, this.data.valueTo);
            if(isNaN(this.data.rateLock) || isNaN(this.data.totalFrom) || isNaN(this.data.rate) || isNaN(this.data.inverseRate) || isNaN(this.data.valueTo)) {
                this.data.showValue = false;
                this.data.replaceValue = true;
                this.data.valueTo = '-' ;
            } else {
                this.data.showValue = true;
                this.data.replaceValue = false;
            }
            this.data.rateLock = this.data.rateLock.toFixed(2);
            this.data.totalFrom = this.data.totalFrom.toFixed(2);
        ...
        buyValue() {
            ...
            this.data.rateLock = this.data.valueFromNumber * 0.001;
            this.data.totalFrom = this.data.valueFromNumber - this.data.rateLock;
            console.log(this.data.rateLock, this.data.totalFrom, this.data.rate, this.data.inverseRate, this.data.valueFrom);
            if(isNaN(this.data.rateLock) || isNaN(this.data.totalFrom) || isNaN(this.data.rate) || isNaN(this.data.inverseRate) || isNaN(this.data.valueFrom)) {
                this.data.showValue = false;
                this.data.replaceValue = true;
                this.data.valueFrom = '-' ;
            } else {
