    ...
    Alpine.data("exchanger", () => ({
        ...
        sellValue() {
            ...
            if(this.data.rateLock == 'Nan' || this.data.totalFrom == 'Nan' || this.data.rate == 'Nan' || this.data.inverseRate == 'Nan' || this.data.valueTo == 'Nan') {
                ...
                this.data.rate = this.data.rate.toFixed(5);
                this.data.inverseRate = this.data.inverseRate.toFixed(5);
        ...
        buyValue() {
            ...
            this.data.rateLock = this.data.valueFromNumber * 0.001;
            this.data.totalFrom = this.data.valueFromNumber - this.data.rateLock;if(this.data.rateLock == 'Nan' || this.data.totalFrom == 'Nan' || this.data.rate == 'Nan' || this.data.inverseRate == 'Nan' || this.data.valueTo == 'Nan') {
                this.data.rateLock = '-';
                this.data.totalFrom = '-';
                this.data.rate = '-';
                this.data.inverseRate = '-';
